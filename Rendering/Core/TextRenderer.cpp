...
namespace FrostEngine
{
    ...
    bool TextRenderer::Init(const char* fontPath, const char* vShaderPath, const char* fShaderPath, unsigned int fontSize)
    {
        if (!m_FontLoader.Load(fontPath, fontSize))
            return false;

        m_Shader = ShaderLoader::Create(vShaderPath, fShaderPath);
